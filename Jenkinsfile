        ...
        tools
             {
              ...
              stages{
                     ...
                     agent { label 'master' }
                      ...
                      agent { label 'master' }
                         steps{
                        sh 'scp -i /var/lib/jenkins/.ssh/id_rsa -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/pipe_mvn_war/target/*.war ubuntu@172.31.26.25:/home/ubuntu/docker-composes/tomcat'
